function probValue = rhocdf(sampleR, nSize, nullRho)
%  RHOCDF calculates the CDF of the Pearson sample correlation coefficient
%  for any given population correlation value nullRHO adn sample size
%
% INPUT:   
...
%    h14 = x14 -  91*x12 + 3003*x10 - 45045*x08 + 315315*x06 -  945945*x04 +  945945*x02 -  135135 ;
    ...
    probValue = normcdf(x, 0, 1) - normpdf(x, 0, 1) * sumA1toA8 ;
